...
import (
	...
	"truechain/discovery/consensus/tbft/help"
	"truechain/discovery/utils"

	"fmt"

	"truechain/discovery/common"
	"truechain/discovery/consensus"
	elect "truechain/discovery/consensus/election"
	...
	"truechain/discovery/crypto/ecies"
...
func (agent *PbftAgent) FetchFastBlock(committeeID *big.Int, infos []*types.CommitteeMember) (*types.Block, error) {
	...
	if infos != nil {
		...
		if fastBlock, _, err = agent.engine.Finalize(agent.fastChain, header, work.state, work.txs, work.receipts, feeAmount, true); err != nil {
